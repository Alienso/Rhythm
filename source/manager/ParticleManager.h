//
// Created by Alienso on 13.8.2024.
//
...
private:
    std::vector<ParticleInstance> particles; //TODO maybe have 2 vectors for alive and dead? //TODO reallocation of this vector leads to destruction of GlBufferWrappers
};
